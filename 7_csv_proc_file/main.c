...
int main( int argc, char *argv[] )
{
	...
	if( argc < 3 )
	{
		...
		printf("for transform csv file to bin file, use command:  \"./csv7 t name_of_csv_file name_of_bin_file\"\n");
		printf("for print out contents of bin flie, use command:  \"./csv7 p name_of_bin_file(s)\"\n");
		exit(0);
	}
	...
	if( argv[1][0] == 't' )  //preform csv2bin transform
	{
		if( argc < 4 )
		{
			...
			printf("./csv7 t filename_csv filename_bin\n");
			exit(0);
		}
